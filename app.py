...
class Venue(db.Model):
    ...
    # TO/DO: implement any missing fields, as a database migration using Flask-Migrate
...
# TO/DO: Implement Show and Artist models, and complete all model relationships and properties, as a database migration.
...
def search_venues():
  # TO/DO: implement search on artists with partial string search. Ensure it is case-insensitive.
...
def create_venue_submission():
  ...
  #venue = Venue(name=form.name.data, city=form.city.data, state=form.state.data, address=form.address.data, phone=form.phone.data, facebook_link=form.facebook_link.data, image_link=form.image_link.data)
...
def show_artist(artist_id):
  ...
  # TO/DO: replace with real artist data from the artist table, using artist_id
  """data1={
    "id": 4,
    "name": "Guns N Petals",
    "genres": ["Rock n Roll"],
  ...
  for show in artist_shows:
    ...
    if show.start_time >= datetime.now():
      upcoming_shows.append(tmp_venue)
    else:
      past_shows.append(tmp_venue)
...
def edit_artist(artist_id):
  ...
  # TODO: edit_artist: populate form with fields from artist with ID <artist_id>
...
def edit_artist_submission(artist_id):
  # TO/DO: edit_artist_submission: take values from the form submitted, and update existing
...
def create_artist_submission():
  ...
  artist = Artist(name=form.name.data, city=form.city.data, state=form.state.data, phone=form.phone.data, genres=form.genres.data, facebook_link=form.facebook_link.data, image_link=form.image_link.data)
...
def create_show_submission():
  ...
  # TO/DO: create_show_submission: insert form data as a new Show record in the db, instead
  ...
  try:
    ...
    # TO/DO: create_show_submission: on unsuccessful db insert, flash an error instead.
